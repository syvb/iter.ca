...
(async () => {
    ...
    accs.push({site_url: "https://meta.stackoverflow.com", user_id: 10113238}); // https://meta.stackexchange.com/q/371659/828089
    for (const acc of accs) {
        ...
        do {
            ...
            posts = await (await fetch(`https://api.stackexchange.com/2.2/users/${acc.user_id}/posts?key=${KEY}&order=desc&sort=activity&site=${siteId}&filter=4F_y7HR4C9TWBKXX&pagesize=100&page=${page}`)).json();
